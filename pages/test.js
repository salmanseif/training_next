    ...
    <div className={Style.container}>
      ...
      <div className={Style.customLink}>
        ...
        <Link href="/hello" passHref>
          <div className={Style.btn}>Kehalaman Hello</div>
        </Link>
      </div>
      ...
      />
      <Image
        src="https://images.unsplash.com/photo-1649810284947-ffad1fa44634?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80"
        alt=""
        width={300}
        height={400}
        className={Style.image}
